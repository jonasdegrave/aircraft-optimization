...
def des_funcs(Xinp):
    ...
    frac_nlg_fwd = result["frac_nlg_fwd"]
    frac_nlg_aft = result["frac_nlg_aft"]

    # Returns
    return SM_fwd, SM_aft, frac_nlg_fwd, frac_nlg_aft
...
df = pd.DataFrame(
    {
        ...
        "SM_fwd": y1_samples,
        "SM_aft": y2_samples,
        "frac_nlg_fwd": y3_samples,
        "frac_nlg_aft": y4_samples,
    }
)
