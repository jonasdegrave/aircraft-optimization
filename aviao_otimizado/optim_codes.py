...
result = differential_evolution(objfun, bounds, polish=False,
                                seed=1, atol=1e-10, maxiter=5000)
...
# Run the optimization algorithm
result = minimize(objfun, x0,
                  method='CG', tol=1e-6, options=options)
...
# Run the optimization algorithm
result = minimize(objfun, x0, jac=objfun_grad,
                  method='CG', tol=1e-6, options=options)
